...
import MateriSlider from './Slider';
        ...
        >
          ...
          <section id="scanner" className="py-24 px-6 z-10 relative">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-[#2d1b0e] border border-[#c5a059]/30 rounded-4xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                <div className="grid md:grid-cols-2">

                  {/* SISI KIRI: INSTRUKSI & VISUAL GUIDE */}
                  <div className="p-10 md:p-16 space-y-10 bg-linear-to-br from-[#2d1b0e] to-[#1a0f06] relative overflow-hidden">
                  ...
                  <div className="bg-[#120a04] p-8 flex items-center justify-center min-h-125 relative border-t md:border-t-0 md:border-l border-[#c5a059]/10">
                    ...
                    {isScanning ? (
                      <div className="w-full flex flex-col items-center gap-6">
                        <div className="relative w-full max-w-[320px] aspect-square border-2 border-[#c5a059]/40 rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(197,160,89,0.1)]">
                          ...
                          <div className="absolute inset-0 pointer-events-none z-20">
                            <div className="w-full h-1 bg-linear-to-r from-transparent via-[#c5a059] to-transparent shadow-[0_0_15px_#c5a059] animate-scan-premium"></div>
                          </div>
                        </div>
                        <button
                      ...
                      <AnimatePresence>
                        <motion.div
                          ...
                          className={`w-full max-w-sm p-8 rounded-4xl border-2 shadow-2xl relative overflow-hidden ${scanResult.category === 'jawaban'
                            ? 'border-red-900/50 bg-linear-to-b from-red-950/40 to-[#120a04]'
                            : 'border-[#c5a059]/50 bg-linear-to-b from-[#2d1b0e] to-[#120a04]'
                            }`}
                        >
                          {/* Label Category */}
